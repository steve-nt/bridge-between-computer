...
## Project Information
- **Project path**: /home/steven/Desktop/bridge-between-computer/D7078 Lab2/aws-s3-java-lab
- **Working branch**: appmod/java-upgrade-20251209154141

- **Java version**: 11

## Development Environment
- **Source JDK path (Java 11)**: /usr/lib/jvm/java-11-openjdk-amd64/bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20251209154141`.
