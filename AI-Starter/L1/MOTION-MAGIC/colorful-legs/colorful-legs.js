...
const legColorButton = document.querySelector("#leg-color");

// Select the left and right leg elements
...
// Your function that gets triggered when clicking the leg-color button
...
// Attach the handleChangeLegColor function to the 'leg-color' button
